        ...
        <ScrollView style={styles.body}>
          ...
          <View style={styles.phoneGrid}>
            ...
            <PhoneGrid
              ...
              fieldValue={
                contacts[0].contact_no.country_code +
                '-' +
                contacts[0].contact_no.work_number
              }
            />
            <PhoneGrid
              ...
              fieldValue={
                contacts[0].contact_no.country_code +
                '-' +
                contacts[0].contact_no.personal_number
              }
            />
          </View>
          ...
          <View style={styles.dobGrid}>
            ...
            <View style={globalStyles.horiZontalRow}></View>
            <View style={styles.fieldBox}>
              <Text style={styles.dobFieldTitle}>Date of Birth:</Text>
              <Text style={styles.dobFieldValue}>
                {contacts[0].date_of_birth.day} /{' '}
                {contacts[0].date_of_birth.month} /{' '}
                {contacts[0].date_of_birth.year}
              </Text>
            </View>
          </View>
          <View style={styles.emailGrid}>
            ...
            <View style={globalStyles.horiZontalRow} />
            <EmailGrid fieldValue={contacts[0].email[0]} />
            <EmailGrid fieldValue={contacts[0].email[1]} />
          </View>
        </ScrollView>
      </View>
    );
